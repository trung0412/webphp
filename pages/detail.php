...
<body>
    ...
    <?php 
        ...
        $sql_chitiet = "SELECT * FROM tbl_danhmuc,tbl_sanpham WHERE tbl_sanpham.id_danhmuc = tbl_danhmuc.id_danhmuc AND tbl_sanpham.id_sanpham='$_GET[id]' LIMIT 1";
    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <h3 class="font-weight-semi-bold">Tên sản phẩm : <?php echo $row_chitiet['tensanpham'] ?></h3>
